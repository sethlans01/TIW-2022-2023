...
public class FullProductDao{
	
	private Connection connection;

	public FullProductDao(Connection connection) {
		this.connection = connection;
	}
	
	public FullProduct findProduct(String code) throws SQLException{
	...
	public List<FullProduct> findProducts(String key) throws SQLException{
