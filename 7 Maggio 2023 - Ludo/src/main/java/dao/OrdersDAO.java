...
public class OrdersDAO {
    ...
    public void addOrder(String orderCode, String sellerCode, float orderCost, Date orderDate, String streetName,
                          int streetNumber, String city, String province, int CAP, String user) throws SQLException{
    ...
    public void addOrderedProduct(String orderCode, String productCode, int quantity, String user) throws SQLException{
        // Add a tuple to the OrderedProducts table
        // Create base structure of the query
        String performedAction = " ordering a product";
        String query = "INSERT INTO ProdottiOrdinati VALUES(?, ?, ?, ?)";
        PreparedStatement preparedStatement = null;
